...
*/
public $layout = 'plantilla_tienda';
/**
...
* @var sting
*/
public $title = 'Tienda de Prendas de Vestir';
public $keywords = 'Ecommerce,Ropa,Zapatos,Prendas';
public $descripcion = 'Una tienda virtual con pago via PAYPAL y REDSYS donde puedes encontrar toda la clase de prendas de vestir';
/**
* Constructor
*
* Inicializa la instancia de CodeIgniter y setea el layout por defecto
*/
public function __construct($layout = 'plantilla_tienda')
{
