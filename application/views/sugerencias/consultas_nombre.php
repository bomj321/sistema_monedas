...
<!--SUB CONSULTA AÑO DE ACUÑACION-->
                    <?php 
                            $sql_ano_acunacion ="SELECT m.*,attr_m.nombre_atributo AS nombreatributo_ano_acunacion,attr_monedas.atributo_moneda as descripcionatributo FROM catalogo_monedas AS m INNER JOIN atributo_monedas AS attr_monedas ON m.id_catalogo_moneda = attr_monedas.id_moneda INNER JOIN atributos_m AS attr_m ON attr_monedas.id_atributo = attr_m.id_atributo_m WHERE m.id_catalogo_moneda = '$usuario->id_catalogo_moneda' AND attr_monedas.tipo_moneda = 0 AND attr_m.nombre_atributo LIKE '%Año acuñación%'";
...
<!--SUB CONSULTA ENSAYADOR-->
                    <?php 
                            $sql_ensayador ="SELECT m.*,attr_m.nombre_atributo AS nombreatributo_ensayador,attr_monedas.atributo_moneda as descripcionatributo FROM catalogo_monedas AS m INNER JOIN atributo_monedas AS attr_monedas ON m.id_catalogo_moneda = attr_monedas.id_moneda INNER JOIN atributos_m AS attr_m ON attr_monedas.id_atributo = attr_m.id_atributo_m WHERE m.id_catalogo_moneda = '$usuario->id_catalogo_moneda' AND attr_monedas.tipo_moneda = 0 AND attr_m.nombre_atributo = 'Ensayador' limit 1";
 ...
 <!--SUB CONSULTA CECA-->
                    <?php 
                            $sql_ceca ="SELECT m.*,attr_m.nombre_atributo AS nombreatributo_ceca,attr_monedas.atributo_moneda as descripcionatributo FROM catalogo_monedas AS m INNER JOIN atributo_monedas AS attr_monedas ON m.id_catalogo_moneda = attr_monedas.id_moneda INNER JOIN atributos_m AS attr_m ON attr_monedas.id_atributo = attr_m.id_atributo_m WHERE m.id_catalogo_moneda = '$usuario->id_catalogo_moneda' AND attr_monedas.tipo_moneda = 0 AND attr_m.nombre_atributo LIKE '%Ceca%'";
...
<!--SUB CONSULTA Gobernante-->
                    ...
                    <?php 
                            $sql_gobernante ="SELECT m.*,attr_m.nombre_atributo AS nombreatributo_gobernante,attr_monedas.atributo_moneda as descripcionatributo FROM catalogo_monedas AS m INNER JOIN atributo_monedas AS attr_monedas ON m.id_catalogo_moneda = attr_monedas.id_moneda INNER JOIN atributos_m AS attr_m ON attr_monedas.id_atributo = attr_m.id_atributo_m WHERE m.id_catalogo_moneda = '$usuario->id_catalogo_moneda' AND attr_monedas.tipo_moneda = 0 AND attr_m.nombre_atributo LIKE '%Gobernante%'";
