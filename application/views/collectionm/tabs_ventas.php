...
<?php $i=0; ?> <!--CODIGO QUE AUTOINCREMENTA EL ID POR UNO PARA EVITAR DUPLICADOS-->                                              
                                <?php if(!empty($monedas_mercado)):?>
                                    <?php foreach($monedas_mercado as $moneda):?>
                                        <tr>
<!--CONSULTAS-->
<?php 
