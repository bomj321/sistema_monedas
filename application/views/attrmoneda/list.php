                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<?php if ($moneda->estado=='1'): ?>
                                            		<a title="bloquear atributo" href="<?php echo base_url();?>attrmoneda/update/<?php echo $moneda->id_atributo_m;?>/0" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                            	<?php else: ?>
