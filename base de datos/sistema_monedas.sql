...
-- -----------------------------------------------------
-- Table `sistema_monedas`.`atributos_especiales_m`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_monedas`.`atributos_especiales_m` (
  `id_atributos_especialesm` INT NOT NULL AUTO_INCREMENT,
  `id_atributom` INT NULL,
  `opciones_especialesm` VARCHAR(100) NULL,
  PRIMARY KEY (`id_atributos_especialesm`),
  INDEX `fk_attresm_atributos_m_idx` (`id_atributom` ASC) ,
  CONSTRAINT `fk_attresm_atributos_m`
    FOREIGN KEY (`id_atributom`)
    REFERENCES `sistema_monedas`.`atributos_m` (`id_atributo_m`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sistema_monedas`.`atributos_especiales_b`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_monedas`.`atributos_especiales_b` (
  `id_atributos_especiales_b` INT NOT NULL AUTO_INCREMENT,
  `id_atributob` INT NULL,
  `opciones_especialesb` VARCHAR(100) NULL,
  PRIMARY KEY (`id_atributos_especiales_b`),
  INDEX `fk_attresb_atributos_b_idx` (`id_atributob` ASC) ,
  CONSTRAINT `fk_attresb_atributos_b`
    FOREIGN KEY (`id_atributob`)
    REFERENCES `sistema_monedas`.`atributos_b` (`id_atributo_b`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
