...
-- -----------------------------------------------------
-- Table `sistema_monedas`.`variantes_moneda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_monedas`.`variantes_moneda` (
  `id_variante_moneda` INT NOT NULL AUTO_INCREMENT,
  `id_cpm` INT NULL,
  `condicion_moneda` VARCHAR(45) NULL,
  `serie_moneda` VARCHAR(45) NULL,
  `subserie_moneda` VARCHAR(45) NULL,
  `numero_moneda` VARCHAR(45) NULL,
  `foto_frente_moneda` VARCHAR(255) NULL,
  `foto_detras_moneda` VARCHAR(255) NULL,
  PRIMARY KEY (`id_variante_moneda`),
  INDEX `fk_cpb_variante_moneda_idx` (`id_cpm` ASC) ,
  CONSTRAINT `fk_cpb_variante_moneda`
    FOREIGN KEY (`id_cpm`)
    REFERENCES `sistema_monedas`.`coleccion_personal_monedas` (`id_coleccion_personal_moneda`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sistema_monedas`.`variantes_billete`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema_monedas`.`variantes_billete` (
  `id_variante_billete` INT NOT NULL AUTO_INCREMENT,
  `id_cpb` INT NULL,
  `condicion_billete` VARCHAR(45) NULL,
  `serie_billete` VARCHAR(45) NULL,
  `subserie_billete` VARCHAR(45) NULL,
  `numero_billete` VARCHAR(45) NULL,
  `foto_frente_billete` VARCHAR(255) NULL,
  `foto_detras_billete` VARCHAR(255) NULL,
  PRIMARY KEY (`id_variante_billete`),
  INDEX `fk_cpb_variante_billete_idx` (`id_cpb` ASC) ,
  CONSTRAINT `fk_cpb_variante_billete`
    FOREIGN KEY (`id_cpb`)
    REFERENCES `sistema_monedas`.`coleccion_personal_billetes` (`id_coleccion_personal_billete`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
